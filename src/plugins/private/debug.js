...
function showSnackbar(processName, message, scroll = true, duration = 3000, iconType = "fa-regular", iconName = "fa-bell", level = "info") {
    ...
    titleDiv.innerText = "通知" + " " + "(" + processName + ")";
    ...
    const functionKit = document.createElement('div');
    functionKit.classList.add('notification_function_kit');
    ...
    functionKit.appendChild(LevelDiv);
    functionKit.appendChild(closeBtn);
    title_top.appendChild(functionKit);
